...
class Real_launch_satellite():
    ...
    def launch(self):
        self.mysystem.sendSatellite('Part5_Satellite_instructions.txt')
	inject_vel=self.start_orbital_injection(7.12474, [-7.41885809782,  -0.23167848846], [-0.241675952253 ,  -2.88286430256]) #Expriment with this
	t1=7.09589438124
	t2=7.5
	t3=8.5
	t4=9.0
