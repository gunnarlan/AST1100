...
class Launch_simulation:
	...
	"""
	Test the implementation of the positioning software
	"""
	...
	"""
	Check the position from the array given by the satellite
	"""
	...
	"""
	Unused earlier function, where we set the sun at the center
	"""
	...
	"""
	Here, we can calculate with any combination of planets
	"""
...
if __name__ == "__main__":
	time_of_first_orientation=3.601
	launch=Launch_simulation(6392)
	launch.check_position_from_array(time_of_first_orientation)

	"""
	Check triangulation software
	"""
	for i in range(1000):
	    launch.get_position(i/50.0)
